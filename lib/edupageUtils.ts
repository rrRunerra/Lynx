...
export class EdupageUtils {
  ...
  public async login() {
    ...
    // The library doesn't seem to expose isLoggedIn property easily checking manually,
    // but re-login is usually safe or we just do it per command execution to be safe.
